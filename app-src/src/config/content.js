...
export const content = {
  ...
  home: {
    ...
    cosaPuoiFare: [
      { titolo: "Orientarti", desc: "Prenotare colloqui individuali e ricevere supporto personalizzato." },
      { titolo: "Partecipare", desc: "Iscriverti ai laboratori e agli eventi del progetto." },
      { titolo: "Informarti", desc: "Consultare opportunità formative e lavorative." },
      { titolo: "Connetterti", desc: "Entrare in contatto con servizi, imprese e reti territoriali." },
    ],
    azioni: [
      { titolo: "Orientation Desk", desc: "Uno sportello permanente di orientamento e accompagnamento personalizzato." },
      { titolo: "Orientation Lab", desc: "30 laboratori esperienziali dedicati allo sviluppo delle competenze e all'orientamento professionale." },
      { titolo: "Job Day", desc: "Eventi dedicati all'incontro tra persone, imprese e servizi per il lavoro." },
      { titolo: "Puglia Donna Partecipa", desc: "Percorsi di empowerment femminile e valorizzazione delle competenze." },
      { titolo: "Puglia Attrattiva #mareAsinistra", desc: "Attività di promozione del territorio e delle sue opportunità oltre i confini comunali." },
    ],
  },
  ...
  progetto: {
    ...
    assetStrategici: [
      { titolo: "Turismo", desc: "Accoglienza, ospitalità, turismo esperienziale e sostenibile." },
      { titolo: "Cultura", desc: "Patrimonio storico, identitario e artistico." },
      { titolo: "Agricoltura", desc: "Produzioni tipiche, filiere agroalimentari e innovazione rurale." },
      { titolo: "Economia del Mare", desc: "Risorse costiere, servizi e opportunità legate al mare." },
      { titolo: "Artigianato", desc: "Competenze tradizionali e nuove forme di imprenditorialità." },
      { titolo: "Ambiente", desc: "Valorizzazione sostenibile del patrimonio naturale." },
    ],
    coordinamento: {
  ...
  orientationDesk: {
    ...
    servizi: [
      { nome: "Accoglienza e primo orientamento", desc: "Analisi dei bisogni e definizione degli obiettivi." },
      { nome: "Bilancio delle competenze", desc: "Valorizzazione delle esperienze e delle capacità personali." },
      { nome: "Piano di sviluppo professionale", desc: "Costruzione di percorsi personalizzati." },
      { nome: "Ricerca attiva del lavoro", desc: "Supporto nella candidatura e nell'inserimento lavorativo." },
      { nome: "Accesso alla formazione", desc: "Orientamento verso corsi e percorsi di aggiornamento." },
      { nome: "Accompagnamento ai servizi", desc: "Connessione con enti, imprese e servizi territoriali." },
    ],
    ...
    aree: [
      {
        ...
        laboratori: [
          { nome: "Food Experience", desc: "Esperienze e opportunità legate alla valorizzazione delle tradizioni enogastronomiche." },
          { nome: "Accoglienza e Ospitalità", desc: "Le competenze richieste nel settore turistico." },
          { nome: "Storytelling del Patrimonio", desc: "Tecniche e strumenti per raccontare il territorio." },
          { nome: "Turismo Esperienziale", desc: "Nuovi modelli di turismo e professioni emergenti." },
          { nome: "Turismo Culturale", desc: "Valorizzazione del patrimonio storico e culturale." },
          { nome: "Eventi e Cultura", desc: "Ideazione e gestione di eventi culturali." },
        ],
      },
      {
        titolo: "AREA 2 – AGRICOLTURA E FILIERE LOCALI",
        laboratori: [
          { nome: "Dal Campo alla Tavola", desc: "Le opportunità delle filiere agroalimentari." },
          { nome: "Agricoltura e Innovazione", desc: "Tecnologie e sostenibilità." },
          { nome: "Comunicazione dei Prodotti Tipici", desc: "Marketing e promozione delle eccellenze locali." },
          { nome: "Green Skills", desc: "Competenze per la transizione ecologica." },
          { nome: "Filiere Agroalimentari", desc: "Conoscere il sistema produttivo locale." },
          { nome: "Economia Circolare e Territorio", desc: "Sviluppo sostenibile e nuove opportunità." },
        ],
      },
      {
        titolo: "AREA 3 – COMPETENZE DIGITALI",
        laboratori: [
          { nome: "Digital Storytelling", desc: "" },
          { nome: "Social Media per il Territorio", desc: "" },
          { nome: "Marketing Territoriale", desc: "" },
          { nome: "Content Creation", desc: "" },
          { nome: "Strumenti Digitali per il Lavoro", desc: "" },
          { nome: "Personal Branding", desc: "" },
        ],
      },
      {
        titolo: "AREA 4 – INCLUSIONE E CITTADINANZA ATTIVA",
        laboratori: [
          { nome: "Empowerment Personale", desc: "" },
          { nome: "Soft Skills per il Lavoro", desc: "" },
          { nome: "Team Working", desc: "" },
          { nome: "Leadership", desc: "" },
          { nome: "Comunità e Partecipazione", desc: "" },
          { nome: "Orientarsi nel Territorio", desc: "" },
        ],
      },
      {
        titolo: "AREA 5 – PROFESSIONI DEL FUTURO",
        laboratori: [
          { nome: "Professioni del Turismo", desc: "" },
          { nome: "Professioni della Cultura", desc: "" },
          { nome: "Professioni Green", desc: "" },
          { nome: "Autoimprenditorialità", desc: "" },
          { nome: "Cooperazione e Impresa Sociale", desc: "" },
          { nome: "Innovazione Territoriale", desc: "" },
        ],
      },
    ],
  },
  ...
  opportunita: {
    titolo: "Opportunità",
    voci: [
      { titolo: "Formazione", desc: "Corsi, laboratori e percorsi di aggiornamento." },
      { titolo: "Lavoro", desc: "Offerte di lavoro e opportunità professionali." },
      { titolo: "Tirocini", desc: "Esperienze formative e di inserimento lavorativo." },
      { titolo: "Autoimpresa", desc: "Bandi, incentivi e strumenti per avviare una nuova attività." },
      { titolo: "Opportunità per i Giovani", desc: "Percorsi dedicati ai giovani e ai NEET." },
      { titolo: "Opportunità per le Donne", desc: "Misure e iniziative dedicate all'occupazione femminile." },
    ],
  },
